...
<head>
  ...
  <div class="container">
    ...
    <?php
      if($type == 'S'){
        echo '<h1 class="text-left px-5">This is a Student account <br>Please Sign Out and Sign In as Employer</h1>';
      }
      else{
          require_once('conn.php');
          $q1 = "SELECT * FROM interns WHERE `$iid` = 'T';";
          $r1 = mysqli_query($dbc, $q1);

          if($r1){
              while($row1 = mysqli_fetch_array($r1)){
                $sid = $row1['sid'];
                $q2 = "SELECT * FROM students WHERE sid='$sid';";
