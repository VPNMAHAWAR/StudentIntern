...
<head>
  ...
  <body class="bg-light">
    ...
    <br>
  <div class="container">
  	<h1 class="text-center">Your Internships</h1>
  	<?php
  		if($check){
  			require_once('conn.php');

  			$query = "SELECT * FROM internships WHERE eid = '$id';";
                  ...
                  <div class="card">
                    <div class="card-header">
                      <a class="collapsed card-link" data-toggle="collapse" href="#';
                        ...
                        echo $row['name'];
                        echo '
                        <a class="btn btn-primary rounded" style="margin-right:5px;float: right;" href="applied.php?iid=';echo $row['iid']; echo '" >Applied Students</a>
                      </a>
                    </div>
                    <div id="';
                    echo $row['iid'];
