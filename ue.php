<?php
    ...
    $query = "SELECT * FROM employers WHERE eid = '$id' AND email = '$email';";
       ...
       <div class="row">
        <div class="col">
            ...
            if($result){
                ...
                echo '<h4>Company Name: '. $row['cname'] . '</h4>';
                echo '<h4>Company Address: '. $row['caddress']. '</h4>';
            }
        ?><br>
        </div>
        <div class="col">
            <h2 class="text-center">Update Profile</h2>
            <form class="form-signup" method="POST" action="eupdate.php">
            ...
            <tr>
                ...
                <td><input type="text" id="cName" name="cname" class="form-control" placeholder="Company Name" maxlength="60"></td>
            </tr>
            <tr>
                <td><b>Company Address: </b></td>
                <td><input type="text" id="cAdd" name="caddress" class="form-control" placeholder="Company Address" maxlength="60"></td>
            </tr>
            <tr>
                <td></td>
