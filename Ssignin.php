...
<head>
  ...
  <body class="bg-light">
    ...
    <div class="container text-center"><br><br>
      ...
      <form class="form-signin" method="POST" action="Ssignin.php">
...
<?php
  if (isset($_POST['email'])){
    ...
    if($result==1){
      ...
      echo '
        Not Signed Up Yet!! Sign Up Now <br><br><a class="btn btn-lg btn-primary btn-block" href="Ssignup.php">Sign Up</a> 
       </p>
       ';
    }
    mysqli_close($dbc);
